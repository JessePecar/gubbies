...
CREATE TABLE [dbo].[Roles] (
    [id] INT NOT NULL IDENTITY(1,1),
    [name] NVARCHAR(1000) NOT NULL,
    [hierarchyTier] INT NOT NULL CONSTRAINT [Roles_hierarchyTier_df] DEFAULT 1,
...
CREATE TABLE [dbo].[Users] (
    ...
    CONSTRAINT [Users_addressId_key] UNIQUE NONCLUSTERED ([addressId])
);
...
-- AddForeignKey
ALTER TABLE [dbo].[RolePermissions] ADD CONSTRAINT [RolePermissions_roleId_fkey] FOREIGN KEY ([roleId]) REFERENCES [dbo].[Roles]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[RolePermissions] ADD CONSTRAINT [RolePermissions_permissionId_fkey] FOREIGN KEY ([permissionId]) REFERENCES [dbo].[Permissions]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE [dbo].[Users] ADD CONSTRAINT [Users_primaryPhoneId_fkey] FOREIGN KEY ([primaryPhoneId]) REFERENCES [dbo].[Phone]([id]) ON DELETE SET NULL ON UPDATE CASCADE;
